<template>
    <view class="page">
        ...
        <view class="header-section">
            <image class="banner-img" src="https://via.placeholder.com/800x400" mode="widthFix"></image>
            <view class="info-box">
        ...
        <!-- 3. 车辆列表 -->
        <view class="car-list">
            <view class="car-card" v-for="(car, index) in carList" :key="car.id">
                <!-- 状态标签 -->
                <view class="status-tag" :class="car.status === 'idle' ? 'tag-green' : 'tag-blue'">
                ...
                <view class="info-wrapper">
                    ...
                    <view class="bottom-row">
                        ...
                        <!-- 按钮：根据状态改变样式 -->
                        <button class="action-btn" :class="{ 'btn-disabled': car.status === 'queue' }"
                            :disabled="car.status === 'queue'" @click="handleDrive(car)">
                            我要驾驶
                        </button>
                    </view>
                </view>
