...
<template>
  <uni-popup ref="popupRef" type="bottom" :mask-click="false">
    <view class="billing-popup">
      ...
      <!-- 按时间计费 -->
      <view class="section" v-if="Object.prototype.hasOwnProperty.call(billData, 'time_billing')">
      ...
      <!-- 按次计费 -->
      <view class="section" v-if="Object.prototype.hasOwnProperty.call(billData, 'one_billing')">
